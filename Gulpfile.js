...
// Server Tasks
//////////////////////////////
gulp.task('build', ['js', 'bowerdependancies']);
gulp.task('server', ['watch', 'browserSyncServer', 'js', 'sass', 'bowerdependancies']);
gulp.task('default', ['watch', 'browserSync', 'js', 'sass', 'bowerdependancies', 'images']);
